  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden">
      ...
      <div className="flex w-full flex-col md:flex-row">
        {/* Cột form */}
        <div className={`flex-1 flex flex-col justify-center items-center px-4 sm:px-0 ${reverse ? "order-2" : "order-1"}`}>
        ...
        {/* Cột hình */}
        <div className={`flex-1 hidden md:flex justify-center items-center p-8 ${reverse ? "order-1" : "order-2"}`}>
